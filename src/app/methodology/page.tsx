      ...
      <section className="mb-10">
        ...
        <div className="space-y-4 text-sm text-slate-600 leading-relaxed">
          ...
          <div>
            ...
            <p>
              現在ポートフォリオの金額入力は本人・配偶者の合算値をベースに期待リターン・標準偏差を計算します。
              配偶者の口座残高はシミュレーション上、本人口座と合算して運用・取崩計算されます。
            </p>
          </div>
        </div>
      </section>
            ...
            <ul className="space-y-3 text-slate-600 text-xs leading-relaxed list-none">
              <li>
                ...
                <p className="mt-0.5">
                  ...
                  本シミュレーターでは簡易計算として、課税退職所得（控除・1/2適用後）に一律 20.315% を適用しています。
                  そのため、実際の税額と差が生じる場合があります。
                </p>
              </li>
              <li>
                <span className="font-medium">② 同年受取時の控除年数の扱い</span>
                <p className="mt-0.5">
                  退職金とiDeCo一時金を同じ年に受け取る場合、本来は重複する加入期間分の控除が制限されます（2022年税制改正）。
                  本シミュレーターでは勤続年数とiDeCo加入年数のうち長い方を採用する簡略化を行っており、実際よりも控除額が多くなるケースがあります。
                </p>
              </li>
              <li>
