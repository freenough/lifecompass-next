      ...
      <section className="mb-10">
        ...
        <div className="space-y-4 text-sm text-slate-600">
          ...
          <div>
            ...
            <p className="mb-1">この充足率は100%以上で「安全」(緑)、80〜100%未満で「注意」(黄)、80%未満で「危険」(赤)として色分けされます。黄色は、まだ達成には届いていないものの、赤(大幅な不足)ほど深刻ではない状態を示します。</p>
            <p className="mb-1">未達成の場合、カード下部に「支出○%減または退職+○年で達成」のように、達成に必要な支出削減率または退職延長年数の目安が自動的に表示されます。退職延長側の年数は、延長期間中も現在と同じペースで貯蓄を続けた場合の試算です。支出削減(上限50%)・退職延長(上限は余命の1年前)のいずれを試しても届かない場合は、「大幅な見直しが必要」と表示されます。</p>
          ...
          <div>
            ...
            <p className="mb-1">退職年齢から年金受給開始年齢までの年数です。この期間は年金収入がなく資産を取り崩して生活するため、長いほど市場変動の影響を受けやすい期間になります。詳細指標(アコーディオン)で確認できます。</p>
            <p>既に退職済みの場合は、現在年齢から年金受給開始年齢までの残り年数に切り替わります。年金を既に受給中の場合は、年数の代わりに「受給中」と表示されます。</p>
          </div>
          <div>
