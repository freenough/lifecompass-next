...
取り崩し時の譲渡益課税、iDeCo受取時の課税など、税金は必要資産額に影響します。田中さんのケースでは、iDeCoを一時金で受け取ると手取り1,494万円、年金(15年)で受け取ると手取り1,540万円という結果になり、受け取り方だけで46万円の差が生まれました。他の項目に比べると影響額は限定的ですが、無視できる金額ではありません。詳しくは「[iDeCoとNISA、どう組み合わせる?](/blog/ideco-nisa)」で解説しています。
