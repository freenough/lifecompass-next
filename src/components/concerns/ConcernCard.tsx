...
export default function ConcernCard({ concern, location }: ConcernCardProps) {
  return (
    <div className="rounded border border-slate-200 bg-white p-6 shadow-sm hover:shadow-md hover:border-slate-300 transition-all">
      ...
      <div className="mt-2 flex flex-col sm:flex-row sm:items-center gap-3">
        <Link
          ...
          className="w-full sm:w-auto text-center border-2 border-accent text-accent font-bold px-6 py-2.5 rounded hover:bg-accent/10 transition-colors"
        >
          {concern.ctaLabel}
        </Link>
        {concern.articleUrl && (
