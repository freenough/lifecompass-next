...
const SIMULATOR_HREF = '/app?utm_source=tools&utm_medium=referral&utm_campaign=prepay_vs_invest_tool';

/**
 * シミュレーターへの導線を主役、アフィリエイトCTAを従とする既存の記事CTAルールと同じ方針
 * （pension-timing/retirement-tax等と完全に同一の構成: CTA1つ+直下に[PR]アフィリエイトリンク）。
      ...
      <div className="w-full rounded-xl bg-slate-50 px-6 py-6 flex flex-col items-center gap-4">
        <div className="text-center">
          <p className="text-sm text-slate-500">
            ...
            資産シミュレーターの住宅ローンイベントに「繰上返済(単発)」を設定すれば、
