...
const SIMULATOR_HREF = '/app?utm_source=tools&utm_medium=referral&utm_campaign=fire_age_tool';
 ...
 */
export default function FireAgeCta({ relatedArticles }: { relatedArticles: { title: string; href: string }[] }) {
  return (
