...
### 完全FIREシナリオ確定値（inflR=1%・教育費なし・退職金800万・retAge=55）※iDeCo取崩前ロック修正後 proportional (2026-07-01)
...
### セミリタイヤシナリオ確定値（生活費base_change→300万・inflR=1%）※iDeCo取崩前ロック修正後 proportional (2026-07-01)
...
### インフレ2%シナリオ確定値（セミリタイヤ+教育費250万×2・inflR=2%）※iDeCo取崩前ロック修正後 proportional (2026-07-01)
