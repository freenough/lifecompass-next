# 年金は繰り上げ・繰り下げどっちが得?損益分岐年齢と「運用した場合」まで試算

**meta description案:** 年金の繰り上げ・繰り下げ受給、どちらが得かを損益分岐年齢で試算。さらに「繰り上げ分を運用に回すと得か」という論点も、資産シミュレーターで実際に検証しました。
...
**〔画像挿入位置:アイキャッチ〕1536×1024px(3:2)。テーマ:年金手帳や年齢の分岐を象徴するビジュアル。構成案は後日別途作成。**
...
ここまで読んで「自分の場合はどうなる?」と思った方は、まずは60秒で、自分の損益分岐年齢だけ確認してみてください。[年金受給タイミング比較シミュレーター](https://www.freenough.com/asset-simulator/tools/pension-timing?utm_source=blog&utm_medium=referral&utm_campaign=pension_timing_blog)
...
**〔画像挿入位置:図版1〕受給開始年齢別の年額比較棒グラフ(4パターン)。構成案は後日別途作成。**
...
**〔画像挿入位置:図版2〕A・B・Cの60〜90歳資産推移折れ線グラフ(3本線)。構成案は後日別途作成。**
...
**〔画像挿入位置:図版3〕A・B・Cの資産分布(下位10%・中央値・上位10%)比較図。構成案は後日別途作成。**
...
1. [年金受給タイミング比較シミュレーター](https://www.freenough.com/asset-simulator/tools/pension-timing?utm_source=blog&utm_medium=referral&utm_campaign=pension_timing_blog)で、繰り上げ・繰り下げ受給時の年金額を算出する
2. [資産シミュレーター](https://www.freenough.com/asset-simulator/app?utm_source=blog&utm_medium=referral&utm_campaign=pension_timing_blog)の「年金受給開始」「年金受給額」欄に、算出した年額を転記する
